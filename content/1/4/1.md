...
*   **Pemetaan Klaster**: **Klaster 1 (Manajemen)** &rarr; Sub-Klaster *Manajemen Prasarana, Peralatan, Keamanan, B3, K3*, serta **Lintas Klaster (Penunjang)** &rarr; *Manajemen Kedaruratan & Bencana*.
*   **Kaitan dengan Siklus Hidup**: Pengelolaan sarana, prasarana, dan peralatan medis yang aman menjamin keselamatan pasien dari seluruh siklus hidup, terutama kelompok rentan seperti ibu hamil, bayi, dan lansia dari risiko infeksi maupun kecelakaan fisik di Puskesmas Pajang.
*   **Dokumen Regulasi & Bukti Pendukung ILP**:
    - **Program MFK**: Dokumen program Manajemen Fasilitas dan Keselamatan Puskesmas Pajang yang disahkan Kepala Puskesmas.
    - **Manifes B3 & APAR**: Daftar inventarisasi bahan berbahaya beracun (B3), manifes limbah B3, kartu kontrol pemeliharaan APAR, dan uji fungsi utilitas listrik/air.

### 📋 Teknik Survei & Penyusunan Rekomendasi (Best Practices)

#### Metode Pembuktian RDOWS:
*   **[R] Regulasi**: Periksa SK/SOP program MFK (Sistem kebakaran, keselamatan, B3, kedaruratan, peralatan medis, dan utilitas).
*   **[D] Dokumen**: Siapkan lembar MSDS B3, bukti simulasi tanggap darurat kebakaran (fire drill), dokumentasi foto jalur evakuasi, dan sertifikat kalibrasi alat medis dari lembaga terakreditasi.
*   **[O] Observasi**: Amati penempatan APAR (tinggi 120 cm), simbol label bahaya B3 di gudang reagen/lab, ketersediaan spill kit, dan petunjuk arah evakuasi bencana.
*   **[W] Wawancara**: Wawancara koordinator MFK dan petugas kebersihan mengenai respon penanganan tumpahan bahan kimia/medis.

#### Contoh Fakta Analisis Kontekstual vs Tekstual:
::code-group{data-pagefind-ignore}
```md [❌ Salah (Tekstual)]
Fakta: Penyimpanan bahan berbahaya dan beracun (B3) di Puskesmas Pajang belum dikelola dengan baik (Skor 5).
Analisis: Ditemukan B3 yang disimpan tidak sesuai dengan panduan MFK.
```
```md [✓ Benar (Kontekstual)]
Fakta: Inventarisasi B3 telah dilakukan di Puskesmas Pajang. Namun, pada observasi di ruang laboratorium dan gudang farmasi, ditemukan 4 botol cairan reagen kimia berbahaya (alkohol 96%, formalin) disimpan di lemari biasa tanpa label simbol bahaya B3 dan lembar MSDS (Material Safety Data Sheet) (Skor 5).
Analisis: Sistem penanganan dan pengamanan bahan B3 belum terlaksana secara aman sesuai dengan standar keselamatan kerja (K3) Puskesmas.
```
::

#### Contoh Rekomendasi Operasional (Kalimat Perintah):
*   **Rekomendasi**: *Pindahkan penyimpanan cairan reagen kimia berbahaya di laboratorium Puskesmas Pajang ke lemari khusus B3, serta lengkapi dengan label simbol bahaya dan lembar MSDS yang sesuai.*
